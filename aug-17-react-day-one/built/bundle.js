  ...
  render: function() {
    return (
      React.createElement("li", null, 
        React.createElement("h2", null, " Name: ", this.props.pokemon.name, " "), 
        React.createElement("p", null, " Level: ", this.props.pokemon.level, "  ")
      )
    )
  }
})
  ...
  render: function() {
   ...
   return (
     React.createElement("section", null, 
       React.createElement("h2", null, "Current Pokemon"), 
...
var Header = React.createClass({displayName: "Header",
  render: function() {
    return (
      React.createElement("section", null, 
        React.createElement("h1", null, "Gotta Catch them All!")
      ) 
    )
  }
})
...
React.render(React.createElement(App, {appName: "My Cool React App"}), document.body)
